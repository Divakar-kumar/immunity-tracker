...
namespace AspNetCoreVerifiableCredentials
{
    ...
    public class IssuerController : ControllerBase
    {
        ...
        public async Task<ActionResult> IssuanceRequest(string firstName,string lastName,string status)
        {
            try
            {
                ...
                payload["issuance"]["claims"]["family_name"] = lastName;
                payload["issuance"]["claims"]["status"] = status;
